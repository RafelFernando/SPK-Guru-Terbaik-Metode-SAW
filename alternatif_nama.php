...
<nav class="navbar">
	...
	<div class="p-5">
		<p class="text-center p-3">Masukan nama alternatif.</p>

    <form action="kriteria_jumlah.php" method="post">
        ...
        <table width="100%">
          <?php
            for ($i = 1; $i <= $_POST['jumlah']; $i++){
               ...
               <tr class='pb-2'>
                 <td class='p-1'>$i.</td>
                 <td class='p-1'><input type='text' class='form-control' placeholder='Alternatif' name='alternatif[$i]'></td>
               </tr>
              ";
            }
          ?>
