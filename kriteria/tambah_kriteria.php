...
<section class="informasi">
    ...
    <form action="" method="POST">
        <table>
            <tr>
                <td>Kode</td>
                <td>:</td>
                <td><input type="text" name="kode" size="18" id="kode"></td>
            </tr>

            <tr>
                <td>Nama Kriteria</td>
                <td>:</td>
                <td><input type="text" name="nama_kriteria" size="18" id="nama_kriteria"></td>
            </tr>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $insert = "INSERT INTO kriteria VALUES ('$kode','$nama_kriteria')";
