...
<body>
    ...
    <div class="button-container">
        <button class="add-button" onclick="window.location.href='tambah_kriteria.php'">
            <i data-feather="plus" class="icon-plus"></i> Tambah Data
        </button>
    </div>
    ...
    <table align="center" border="1px solid black" cellpadding="5" class="tabel-transaksi">
        ...
        <tr>
            ...
            <td>
                <a href="edit_kriteria.php?kode=<?php echo $hasil['kode']; ?>" class="edit-btn">Edit</a>
                <a href="hapus_kriteria.php?kode=<?php echo $hasil['kode']; ?>" class="hapus-btn">Hapus</a>
            </td>
        </tr>
