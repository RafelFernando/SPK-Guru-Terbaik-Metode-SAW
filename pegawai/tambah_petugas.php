...
<body>
        ...
        <form action="" method="POST">
            <table>
                <tr>
                    <td>NIP</td>
                    <td>:</td>
                    <td><input type="text" name="nim" size="18" id="nim"></td>
                </tr>

                <tr>
                    <td>Nama Petugas</td>
                    <td>:</td>
                    <td><input type="text" name="nm_ptgs" size="18" id="nm_ptgs"></td>
                </tr>
                ...
                <tr>
                    <td>Tempat Lahir</td>
                    <td>:</td>
                    <td><input type="text" name="tmplhr_ptgs" size="18" id="tmplhr_ptgs"></td>
                </tr>

                <tr>
                    <td>Tanggal Lahir</td>
                    <td>:</td>
                    <td><input type="text" name="tgllhr_ptgs" size="18" id="tgllhr_ptgs"></td>
                </tr>

                <tr>
                    <td>Alamat</td>
                    <td>:</td>
                    <td><input type="text" name="alm_ptgs" size="18" id="alm_ptgs"></td>
                </tr>

                <tr>
                    <td>Jabatan</td>
                    <td>:</td>
                    <td><input type="text" name="jabatan" size="18" id="jabatan"></td>
                </tr>

                <tr>
                    <td>No Telp</td>
                    <td>:</td>
                    <td><input type="text" name="no_telp" size="18" id="no_telp"></td>
                </tr>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        $nim = $_POST['nim'];
        $nm_ptgs = $_POST['nm_ptgs'];
        $jk = $_POST['jk'];
        $tmplhr_ptgs = $_POST['tmplhr_ptgs'];
        $tgllhr_ptgs = $_POST['tgllhr_ptgs'];
        $alm_ptgs = $_POST['alm_ptgs'];
        $jabatan = $_POST['jabatan'];
        $no_telp = $_POST['no_telp'];

        $insert = "INSERT INTO pegawai VALUES ('$nim','$nm_ptgs','$jk','$tmplhr_ptgs','$tgllhr_ptgs','$alm_ptgs','$jabatan','$no_telp')";
