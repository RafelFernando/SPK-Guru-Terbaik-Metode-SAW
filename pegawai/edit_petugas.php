...
<body>
    ...
    <h2>Edit Akun Pegawai</h2>
        ...
        <?php
        include "koneksi.php";
        $editData = mysqli_query($koneksi, "SELECT * FROM pegawai WHERE nip='$_GET[nip]'");
        ...
        <table>
                <tr>
                    <td>NIP</td>
                    <td>:</td>
                    <td><input type="text" name="nip" size="18" value="<?php echo $d['nip']; ?>"></td>
                </tr>

                <tr>
                    <td>Nama Petugas</td>
                    <td>:</td>
                    <td><input type="text" name="nm_ptgs" size="18" value="<?php echo $d['nm_ptgs']; ?>"></td>
                </tr>
                ...
                <tr>
                    <td>Tempat Lahir</td>
                    <td>:</td>
                    <td><input type="text" name="tmplhr_ptgs" size="18" value="<?php echo $d['tmplhr_ptgs']; ?>"></td>
                </tr>

                <tr>
                    <td>Tanggal Lahir</td>
                    <td>:</td>
                    <td><input type="text" name="tgllhr_ptgs" size="18" value="<?php echo $d['tgllhr_ptgs']; ?>"></td>
                </tr>

                <tr>
                    <td>Alamat</td>
                    <td>:</td>
                    <td><input type="text" name="alm_ptgs" size="18" value="<?php echo $d['alm_ptgs']; ?>"></td>
                </tr>

                <tr>
                    <td>Jabatan</td>
                    <td>:</td>
                    <td><input type="text" name="jabatan" size="18" value="<?php echo $d['jabatan']; ?>"></td>
                </tr>

                <tr>
                    <td>No Telp</td>
                    <td>:</td>
                    <td><input type="text" name="no_telp" size="18" value="<?php echo $d['no_telp']; ?>"></td>
                </tr>
                ...
                <tr>
                    ...
                    <div class="button-group">
                        ...
                        <button type="button" class="btn-cancel" onclick="window.location.href='data_petugas.php'">Batal</button>
                    </div>
                    </td>
                </tr>
            </table>
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        $update = mysqli_query($koneksi, "UPDATE pegawai SET nm_ptgs='$_POST[nm_ptgs]', jk='$_POST[jk]', 
                    tmplhr_ptgs='$_POST[tmplhr_ptgs]', tgllhr_ptgs='$_POST[tgllhr_ptgs]', alm_ptgs='$_POST[alm_ptgs]', jabatan='$_POST[jabatan]', no_telp='$_POST[no_telp]' WHERE nip='$_POST[nip]'");
        if ($update) {
            $success = "Pegawai berhasil diedit!";
        } else {
    ...
    <?php if (isset($success)): ?>
        <div class="alert">
            <div class="box">
                ...
                <button onclick="window.location='data_petugas.php'" class="btn-alert">Ok</button>
            </div>
        </div>
