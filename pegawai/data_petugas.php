...
<body>
    ...
    <div class="button-container">
        <button class="add-button" onclick="window.location.href='tambah_petugas.php'">
            <i data-feather="plus" class="icon-plus"></i> Tambah Pegawai
        </button>
    </div>
        ...
        <tr class="isi">
            <th><?php echo $no?></th>
            <th><?php echo $hasil['nip']?></th>
            <th><?php echo $hasil['nm_ptgs']?></th>
            <th><?php echo $hasil['jk']?></th>
            <th><?php echo $hasil['tmplhr_ptgs']?></th>
            <th><?php echo $hasil['tgllhr_ptgs']?></th>
            <th><?php echo $hasil['alm_ptgs']?></th>
            <th><?php echo $hasil['jabatan']?></th>
            <th><?php echo $hasil['no_telp']?></th>
            <th>
                <a href="edit_petugas.php?nip=<?php echo $hasil['nip']; ?>" class="edit-btn">Edit</a>
                <a href="hapus_petugas.php?nip=<?php echo $hasil['nip']; ?>" class="hapus-btn">Hapus</a>
            </th>
        </tr>
