...
<body>
    ...
    <?php
        include "config.php";
        $editData = mysqli_query($con, "SELECT * FROM user WHERE username='$_GET[username]'");
        ...
        <table>
                <tr>
                    <td>Username</td>
                    <td>:</td>
                    <td><input type="text" name="username" size="18" value="<?php echo $d['username']; ?>"></td>
                </tr>

                <tr>
                    <td>Password</td>
                    <td>:</td>
                    <td><input type="text" name="password" size="18" value="<?php echo $d['password']; ?>"></td>
                </tr>
                ...
                <tr>
                    ...
                    <div class="button-group">
                        ...
                        <button type="button" class="btn-cancel" onclick="window.location.href='data_akun.php'">Batal</button>
                    </div>
                    </td>
                </tr>
            </table>
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        $update = mysqli_query($con, "UPDATE user SET password='$_POST[password]' WHERE username='$_POST[username]'");
        if ($update) {
    ...
    <?php if (isset($success)): ?>
        <div class="alert">
            <div class="box">
                ...
                <button onclick="window.location='data_akun.php'" class="btn-alert">Ok</button>
            </div>
        </div>
