...
<body>
    ...
    <!--ini bagian gambar pembuat tugas kami-->
    ...
    <section class="informasi">
        ...
        <div class="row">
            <div class="menu-card">
              <img src="gambar/ilham.png" alt="Caffe Latte" class="menu-card-img">
              <h3 class="menu-card-title"> Muhammad Ilham AA </h3>
              <p class="menu-card-kelas">220101027</p>
            </div>

            <div class="menu-card">
                <img src="gambar/rafel.png" alt="Caffe Latte" class="menu-card-img">
                <h3 class="menu-card-title"> Rafel Fernando </h3>
                <p class="menu-card-kelas">220101031</p>
            </div>

            <div class="menu-card">
                <img src="gambar/donaa.jpg" alt="Caffe Latte" class="menu-card-img">
                <h3 class="menu-card-title"> Romadona </h3>
                <p class="menu-card-kelas">220101036</p>
            </div>

            <div class="menu-card">
                <img src="gambar/torik.png" alt="Caffe Latte" class="menu-card-img">
                <h3 class="menu-card-title"> Tariq </h3>
                <p class="menu-card-kelas">220101037</p>
              </div>
        </div>
    </section>
